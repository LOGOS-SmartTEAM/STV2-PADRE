...
Unique device address: <mark>0x24</mark>
...
### LED Strip Module (Base Address: `0x0A`)

| Offset Address | Register Name   | Function Description                | Data Length (Bytes)                | Value Range / Description |
| -------------- | --------------- | ----------------------------------- | ---------------------------------- | ------------------------- |
| 0x00           | LED Strip Color | Set color for all LEDs              | 4                                  | 0-255: light r g b        |
| 0x01           | LED Strip Color | Set color for each LED individually | 18 (6 LEDs total, 3 bytes per LED) | 0-255: (r, g, b) * 6      |
